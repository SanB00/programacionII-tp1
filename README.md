...
- The delete of a book or member record, is managed by a feature flag which will allow the recording of a lend (Image 1)
...
- When a lend is being registered, we check the existance of both Libros and Socios (Image 2)
...
- It has reports (Informes) for the sellest book, the member that asked more books historically, the quantity of books a member has and the number of books per month which was lent through a requested year. (Image 3)

### Demo Images

1. ![Libros](./images/Libros.gif "Libros...")
2. ![Prestamos](./images/Prestamos.gif "Prestamos")
3. ![Informes](./images/Informes.gif "Informes...")
